...
## Setup Prior to Initiating the RStudio Web Service {.smaller style="font-size: 0.56em"}
...
::: fragment
![RStudio view](/work/richherr/UNT_workshops/RStudio.png){.fragment width="860" height="425"}
:::
